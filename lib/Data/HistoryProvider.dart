...
class HistoryProvider with ChangeNotifier {
  ...
  static const String _frequencyKey = 'item_frequency';
  static const String _lastPurchasedKey = 'last_purchased';
  ...
  void addShoppingSession(List<GroceryItem> completedItems) {
    ...
    final session = ShoppingSession(
      ...
      totalSpent: completedItems.length * 5.0, // Estimated $5 per item as placeholder
    );
    ...
    if (_shoppingHistory.length > 50) {
      _shoppingHistory = _shoppingHistory.take(50).toList();
    }
